...
class Bunyip:
    ...
    def update_from_geometry(self, diagnose=False):
        """Update light curve parameters from geometric information contained
        within the eclipse times and depths.
        
        Parameters
        ----------
        diagnose : bool, optional
            Whether to show a diagnostic plot of estimate eclipse ingress and 
            egress positions, by default False
        """
    ...
    def update_from_knn(self):
        """Update light curve parameters from KNN model
        """
        model = KNN()
